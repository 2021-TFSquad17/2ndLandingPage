    ...
    return (
        <section className="video bg-light">
            <div className="text-video">
                <h2 className="text-video-title page-section h2.section-heading text-uppercase">Conheça mais do nosso projeto e a sua <a className="destaque">importância</a> </h2>
            ...
            <iframe className="insertVideo" width="657.05" height="436.22" src="https://www.youtube.com/embed/eYWu3QRGRW4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </section>
